<?php
	...
	<tr>
	<td>District</td>
	<td><input type="text" name="District" placeholder="Equitation and Farriers"required/></td><br />
	</tr>
	
	<tr>
	<td>Station</td>
	<td><input type="text" name="Station" placeholder="Equitation"required/></td><br />
	</tr>
