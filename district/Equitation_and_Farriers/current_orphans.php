...
<?php
	...
	WHERE District='Equitation And Farriers'";
	...
	while($row_orphan=mysqli_fetch_array($run_orphan)){
		...
		$welfare_fund_beneficiary=$row_orphan['Welfare_Fund_Beneficiary'];
...
?>
	...
	<td> <?php echo $welfare_fund_beneficiary; ?> </td>
